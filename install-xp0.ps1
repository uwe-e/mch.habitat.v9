...
function Install-Prerequisites {
   ...
   #$jrePath = "HKLM:\SOFTWARE\JavaSoft\Java Runtime Environment"
    $jrePath = "HKCU:\SOFTWARE\JavaSoft\Java Runtime Environment"
	#$jdkPath = "HKLM:\SOFTWARE\JavaSoft\Java Development Kit"
    $jdkPath = "HKCU:\SOFTWARE\JavaSoft\Java Development Kit"
	#$jrePath9 = "HKLM:\SOFTWARE\JavaSoft\JRE"
    $jrePath9 = "HKCU:\SOFTWARE\JavaSoft\JRE"
    #$jdkPath9 = "HKLM:\SOFTWARE\JavaSoft\JDK"
    $jdkPath9 = "HKCU:\SOFTWARE\JavaSoft\JDK"
    ...
    #UE the needed versions are listed within the "Property" property
    $javaVersionStrings = Get-ChildItem $path | ForEach-Object { $parts = $_.Property.Split("\"); $parts[$parts.Count-1] } 
